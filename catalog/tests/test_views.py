...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(
            response, 'catalog/list_user_books.html')
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        renew_permission = Permission.objects.get(
            name='Renew books for loaning')
        test_user2.user_permissions.add(renew_permission)
        return_permission = Permission.objects.get(name='Set book as returned')
        test_user2.user_permissions.add(return_permission)
        test_user2.save()
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        response = self.client.post(reverse('renew-book-librarian', kwargs={
                                    'pk': self.test_bookinstance1.pk, }), {'due_back': valid_date_in_future})
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirects_to_authors_on_success(self):
        login = self.client.login(
            username='testuser2', password='2HJ1vRV0Z&3iD')
    ...
    def test_error_if_max_length_exceeded(self):
        login = self.client.login(
            username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.post(reverse('author-create'), {
            'first_name': 'John',
        ...
        self.assertFormError(response, 'form', 'last_name',
                             'Ensure this value has at most 100 characters (it has 250).')
